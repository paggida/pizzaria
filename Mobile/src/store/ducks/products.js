...
export const Types = {
  ...
  REQUEST_TYPES: 'products/REQUEST_TYPES',
  REQUEST_SIZES: 'products/REQUEST_SIZES',
  SUCCESS_PRODUCTS: 'products/SUCCESS_PRODUCTS',
  SUCCESS_TYPES: 'products/SUCCESS_TYPES',
  SUCCESS_SIZES: 'products/SUCCESS_SIZES',
  FAILURE_REQUEST: 'products/FAILURE_REQUEST',
};
/**
 * Reducer
 */
